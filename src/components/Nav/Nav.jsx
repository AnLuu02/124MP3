        ...
        <>
            <ul className={cx("navSidebar")}>
                ...
                <NavItem
                    ...
                    title="Thư viện"
                    // onClick={handleHideSidebar}
                    className={{ "nav_library": true }}
                    iconFontAwesome={<FontAwesomeIcon className={cx("icon")} icon={faCompactDisc} />}
                />
            </ul>
            <span className={cx("line")}></span>
            <ul className={cx("navSidebar", "nav2", song?.name ? "isSong" : "")}>
                <NavItem
                    key={"bxh"}
                    to="/bxh"
                    title="BXH Nhạc Mới"
                ...
                {!isLoggedIn ? <div className={cx("yeucaulogin", "mobile")} >
                    <div>
                        <p>
                    ...
                    :
                    <div className={cx("yeucaulogin", "upPremium", "mobile")} >
                        <div>
                            <p>
                                Nghe nhạc không quảng cáo cùng kho nhạc PREMIUM
                            </p>
                            <SignInwithGoogle>
                                <button className={cx("btnLogin")}>Nâng cấp tải khoản</button>
                            </SignInwithGoogle>
                        </div>
                    </div>
                }
                ...
                {isLoggedIn && <>
                            ...
                            <div className={cx("icon")} >
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <defs><linearGradient
                                        ...
                                        gradientUnits="userSpaceOnUse"><stop stopColor="#8E4CFF">

                                        </stop><stop offset="1" stopColor="#7729FF">
                    ...
                    <NavItem
                        ...
                        iconSvg={
                            <div className={cx("icon")} >
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path fillRule="evenodd" clipRule="evenodd" d="M0.5164 7.14319C1.32829 3.21545 3.8263 1.02782 7.72282 0.366909C10.6032 -0.121503 13.4847 -0.12767 16.3602 0.380652C20.3723 1.08984 22.7841 3.40504 23.5524 7.39215C24.1461 10.4736 24.1554 13.5879 23.5431 16.6663C22.7218 20.5669 20.1593 22.9747 16.2772 23.6331C13.3968 24.1215 10.5153 24.1277 7.63977 23.6193C3.62772 22.9102 1.20521 20.4794 0.436861 16.4923C-0.186982 13.3905 -0.126933 10.2566 0.5164 7.14319Z" fill="url(#paint0_linear_2645_12884)"></path><path d="M14 10.5H18.5" stroke="#FEFFFF" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"></path><path d="M14 14H18.5" stroke="#FEFFFF" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"></path><path d="M5.5 17.5H18.5" stroke="#FEFFFF" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"></path><path fillRule="evenodd" clipRule="evenodd" d="M10.7683 4.96334C10.5823 4.87034 10.3614 4.88028 10.1845 4.9896C10.0077 5.09893 9.89999 5.29205 9.89999 5.49999V9.38364C9.37521 8.97604 8.71596 8.73334 8.00002 8.73334C6.28794 8.73334 4.90002 10.1213 4.90002 11.8333C4.90002 13.5454 6.28794 14.9333 8.00002 14.9333C9.61245 14.9333 10.9374 13.7023 11.0861 12.1288C11.0952 12.0873 11.1 12.0442 11.1 12V11.8486C11.1 11.8435 11.1 11.8384 11.1 11.8333C11.1 11.8283 11.1 11.8232 11.1 11.8181V6.47081L13.2317 7.53665C13.528 7.68484 13.8885 7.56471 14.0366 7.26832C14.1848 6.97194 14.0647 6.61153 13.7683 6.46334L10.7683 4.96334ZM9.89999 11.8214V11.8453C9.89357 12.8891 9.04539 13.7333 8.00002 13.7333C6.95068 13.7333 6.10002 12.8827 6.10002 11.8333C6.10002 10.784 6.95068 9.93334 8.00002 9.93334C9.04539 9.93334 9.89357 10.7776 9.89999 11.8214Z" fill="#FEFFFF"></path><defs><linearGradient id="paint0_linear_2645_12884" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop stopColor="#FA7433"></stop><stop offset="1" stopColor="#FA6D29"></stop></linearGradient></defs></svg>
                            </div>
                        }
                    />
                ...
                <NavItem
                    ...
                    to="#"
                    title="Tạo playlist"
                    className={{ nav_playlist: true, mobile: true }}
                    // onClick={handleHideSidebar}
                    onClick={() => {
                        if (isLoggedIn) {
                            return onShowModal()
                ...
                />
                <li className={cx("create_playlist", "mobile")} onClick={handleToggleSidebar}>
                    <div>
                        {isShowSidebar
                            ?
