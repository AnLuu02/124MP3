...
function Top() {
    return (<>
        <div className={cx("home")} id={cx("top")} >
            ...
            <div className={cx("top_music")} id={cx("outStanding")} >
            ...
            <div className={cx("top_music")} id={cx("vn_music")} >
                <div className={cx("title_main")} >
                    Nhạc Việt Nam
                </div >
                <WidgetAlbum />
            ...
            <div className={cx("top_music")} id={cx("asia_music")}>
                <div className={cx("title_main")}>
                    Nhạc Châu Á
                </div>  <WidgetAlbum />
            </div >

            <div className={cx("top_music")} id={cx("uk_music")}>
                <div className={cx("title_main")}>
                    Nhạc Âu Mỹ
                </div>
                <WidgetAlbum />
            ...
            <div className={cx("top_music")} id={cx("concert_music")}>
                <div className={cx("title_main")}>
                    Nhạc Hòa Tấu
                </div>
                <WidgetAlbum />
